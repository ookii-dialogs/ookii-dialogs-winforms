...
Task("restore")
    ...
    .Does(() =>
{
    DotNetRestore("./Ookii.Dialogs.WinForms.sln", new DotNetRestoreSettings
    {
        LockedMode = true,
    });
});
...
{
    DotNetBuild("./Ookii.Dialogs.WinForms.sln", new DotNetBuildSettings
    {
    ...
    .Does(() =>
{
    ...
    DotNetPack("./src/Ookii.Dialogs.WinForms/Ookii.Dialogs.WinForms.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,
    ...
    DotNetPack("./src/Ookii.Dialogs.WindowsForms/Ookii.Dialogs.WindowsForms.csproj", new DotNetPackSettings
    {
        Configuration = "Release",
        NoRestore = true,
        NoBuild = true,

namespace Ookii.Dialogs.WinForms.Sample
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._sampleTaskDialog = new Ookii.Dialogs.WinForms.TaskDialog(this.components);
            this._customTaskDialogButton = new Ookii.Dialogs.WinForms.TaskDialogButton(this.components);
            this._okTaskDialogButton = new Ookii.Dialogs.WinForms.TaskDialogButton(this.components);
            this._cancelTaskDialogButton = new Ookii.Dialogs.WinForms.TaskDialogButton(this.components);
            ...
            this._sampleCommandLinkTaskDialog = new Ookii.Dialogs.WinForms.TaskDialog(this.components);
            this._elevatedTaskDialogButton = new Ookii.Dialogs.WinForms.TaskDialogButton(this.components);
            this._otherTaskDialogButton = new Ookii.Dialogs.WinForms.TaskDialogButton(this.components);
            this._cancel2TaskDialogButton = new Ookii.Dialogs.WinForms.TaskDialogButton(this.components);
            this._sampleProgressDialog = new Ookii.Dialogs.WinForms.ProgressDialog(this.components);
            this._sampleInputDialog = new Ookii.Dialogs.WinForms.InputDialog(this.components);
            this._sampleCredentialDialog = new Ookii.Dialogs.WinForms.CredentialDialog(this.components);
            this._sampleVistaFolderBrowserDialog = new Ookii.Dialogs.WinForms.VistaFolderBrowserDialog();
            this._sampleVistaOpenFileDialog = new Ookii.Dialogs.WinForms.VistaOpenFileDialog();
            this._sampleVistaSaveFileDialog = new Ookii.Dialogs.WinForms.VistaSaveFileDialog();
            this.SuspendLayout();
            // 
            // _sampleTaskDialog
            // 
            ...
            this._sampleTaskDialog.HyperlinkClicked += new System.EventHandler<Ookii.Dialogs.WinForms.HyperlinkClickedEventArgs>(this._sampleTaskDialog_HyperlinkClicked);
            // 
            ...
            // 
            this._cancelTaskDialogButton.ButtonType = Ookii.Dialogs.WinForms.ButtonType.Cancel;
            // 
            // _dialogLabel
            // 
            ...
            this._sampleCommandLinkTaskDialog.ButtonStyle = Ookii.Dialogs.WinForms.TaskDialogButtonStyle.CommandLinks;
            ...
            // 
            this._cancel2TaskDialogButton.ButtonType = Ookii.Dialogs.WinForms.ButtonType.Cancel;
            // 
            ...
            this.Name = "MainForm";
            this.Text = "Ookii.Dialogs.WinForms sample";
